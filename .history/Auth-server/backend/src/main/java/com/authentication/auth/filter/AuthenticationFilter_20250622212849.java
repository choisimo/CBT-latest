    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (identifier == null || password == null || password.isBlank()) {
                log.error("로그인 요청에 유효한 식별자 또는 비밀번호가 누락되었습니다. Provided email: '{}', loginId: '{}', username: '{}', passwordIsBlank: {}",
                        credentials.get("email"), credentials.get("loginId"), credentials.get("username"), (password == null || password.isBlank()));
