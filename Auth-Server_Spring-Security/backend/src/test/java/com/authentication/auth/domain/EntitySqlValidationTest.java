...
import com.authentication.auth.validator.EntityValidationOutput;
...
public class EntitySqlValidationTest {
    ...
    public void testAuthProviderEntityAgainstSql() {
        ...
        // 엔티티와 SQL 검증
        List<EntitySqlValidator.ValidationResult> results = 
                EntitySqlValidator.validate(AuthProvider.class, sqlStatement);
        
        // 결과 표시
        EntityValidationDisplayService.displayResults(results);
